package com.girnarsoft.android.shunshine.service;
...
public class SunshineService extends IntentService {
    ...
    private Void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cVVector.toArray(new ContentValues[]{}));
            }
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, null,
        ...
        if(cursor.getCount() > 0){
            ...
            Uri uri = getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
