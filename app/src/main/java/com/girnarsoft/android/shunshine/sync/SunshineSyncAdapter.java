package com.girnarsoft.android.shunshine.sync;
...
import com.girnarsoft.android.shunshine.MainActivity;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = getContext().getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, null,
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                String contentText = String.format(context.getString(R.string.format_notification),
                        desc,
                        Utility.formatTemperature(context, high, true),
